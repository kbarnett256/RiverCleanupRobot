...
private:
    ...
    double                  m_fBaseAvg[512] = {};
    double                  m_fBaseStdDev[512] = {};
    ...
    /// </summary>
    void                    ProcessDepth(INT64 nTime, const UINT16* pBuffer, int nHeight, int nWidth, USHORT nMinDepth, USHORT nMaxDepth, char*packet);
